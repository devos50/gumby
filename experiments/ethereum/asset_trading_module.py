...
class AssetTradingModule(ExperimentModule):
    ...
    def ask(self, asset1_amount, asset1_type, asset2_amount, asset2_type, order_id=None):
        ...
        market_contract.functions.offer(stripped_order_id, int(asset1_amount), asset1_type, int(asset2_amount), asset2_type, 0, False).transact({"gas": 1000000, "from": w3.eth.accounts[0]})
    ...
    def bid(self, asset1_amount, asset1_type, asset2_amount, asset2_type, order_id=None):
        ...
        market_contract.functions.offer(stripped_order_id, int(asset2_amount), asset2_type, int(asset1_amount), asset1_type, 0, False).transact({"gas": 1000000, "from": w3.eth.accounts[0]})
